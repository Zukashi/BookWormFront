...
export const OneBookUser = (props:{id:{
    ...
    return (<>
        ...
        <div className='flex relative gap-2  w-[95%] mx-auto'>
            <Link to={`/book/${book._id}`} className='  flex justify-center  items-center  '><div className='h-[250px] flex justify-center items-center w-36'><img  src={`https://covers.openlibrary.org/b/isbn/${book.isbn}-L.jpg?default=false`} onError={(e) => {
            ...
            }}  aria-label={`Click to redirect to ${book.title}`}   className=" cursor-pointer w-36"   alt=""/></div>
