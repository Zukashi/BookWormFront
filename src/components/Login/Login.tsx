...
import {DrawerComponent} from "../Home/DrawerComponentUser";
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className='bg-gradient-to-r from-sky-500 to-indigo-500 w-screen h-screen flex items-center justify-center'>
                <div className='flex flex-col absolute top-60 '>
                    ...
                    <Input style={{border:'none', backgroundColor:'rgba(240, 239, 235,0.3)'}}className='focus:outline-none focus:ring focus:ring-blue-700  placeholder:italic placeholder:text-white 'placeholder='User Name' focusBorderColor='none'   {...register('username')}></Input>
                    <InputGroup size='md'>
                    ...
                    <div className='w-full flex justify-center'><input className='mt-5 bg-loginBtn px-3 py-3 w-[7rem] rounded-md font-medium text-2xl text-white' type={"submit"} ></input></div>
