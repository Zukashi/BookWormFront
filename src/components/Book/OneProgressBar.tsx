...
export const OneProgressBar =({isHighlighted,sumOfRatings,book,index}:{book:BookEntity, index:number,isHighlighted:  boolean[], sumOfRatings:number}) => {
    ...
    return <>
        ...
        <div className={` py-[1rem]  px-[1rem] mr-2 group-hover:bg-[#ebebeb]   z-0 w-[80%] ${isHighlighted[(book as any).ratingTypeAmount.length - 1 - index] && 'bg-[#c1c1c1] group-hover:bg-[#c1c1c1]'
        } rounded-2xl`}>
