          ...
          <div className={`w-screen mx-auto absolute -bottom-2 left-0 w-screen bg-white rounded-xl pb-10 ${!modal  ? '-bottom-[268px]' : '-bottom-2'}`}>
            <div className='w-[85%] mx-auto'>
              ...
              <div className='flex flex-col gap-3'>
                ...
                <div className={`border-2 border-[#271c148f] rounded-3xl px-2 py-1.5 cursor-pointer flex ${statusUnformatted === 'currentlyReading' && 'bg-[#aaa] border-3 border-[#000]'}`} onClick={() => updateStatusOfBook('currentlyReading')}><button className='w-full '><span className='font-medium flex justify-center items-center'>{statusUnformatted === 'currentlyReading' &&
