...
export const HomeNav = () => {
 ...
 //  }
  ...
  return (<>
    <nav className='w-100vw  flex justify-center mt-2'>
        <Image className='fixed top-0' boxSize='50px' src="https://cdn-icons-png.flaticon.com/512/2490/2490314.png"></Image>
